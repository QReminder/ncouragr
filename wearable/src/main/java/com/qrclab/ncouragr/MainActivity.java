...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final WatchViewStub wvs = (WatchViewStub) findViewById(R.id.watch_view_stub);
        final WatchViewStub.OnLayoutInflatedListener listener
            = new WatchViewStub.OnLayoutInflatedListener() {
                    @Override
                    public void onLayoutInflated(WatchViewStub wvs) {
                        mInputTextView  = (TextView) findViewById(R.id.input);
                        mOutputTextView = (TextView) findViewById(R.id.output);
                    }
                };
        wvs.setOnLayoutInflatedListener(listener);
